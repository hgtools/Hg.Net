...
namespace Mercurial.Tests
{
    ...
    public class AllFilesInProjectsAreUtf8Encoded
    {
        ...
        public static IEnumerable<string> AllSourceFilesInProjectsInFolder(string sourceLocation)
        {
        ...
        public static IEnumerable<string> AllSourceFilesInProjects()
        {
            return AllSourceFilesInProjectsInFolder(GetSourceLocation());
        }

        public static IEnumerable<string> AllUnknownExtensions()
        {
        ...
        [TestCaseSource(nameof(AllUnknownExtensions))]
